...
-- ----------------------------
BEGIN;
INSERT INTO `estudiantes` VALUES ('1231231', '1231231', 'Julio', 'ce', 'sadas', '23423', 'jsarmiento@gmail.com', 'Hombre', 'asdasdas', 'Abejorral', 'Abejorral'), ('002', '393741', 'Julio', 'Sarmiento', 'NM', '3114110213', 'jsarmientop.inca@gmail.com', 'Hombre', 'Programar', 'Atlántico', 'Repelón');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `usuarios` VALUES ('0001', 'danna', '1', '123'), ('0004', 'tocayo', '2', '1234'), ('001', 'danna', '1', '123'), ('002', 'carlos', '2', '2'), ('003', '2', '1', '123'), ('005', 'admin', '1', '1'), ('1407', 'rubertel', '1', '2017');
COMMIT;
